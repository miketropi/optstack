 ...
 * User Store
 *
 * Store adapter for WordPress user meta (wp_usermeta table).
...
class UserStore implements StoreInterface
{
     ...
     */
    public function __construct(int $userId, string $metaKey)
    {
        $this->userId = $userId;
    ...
    public function deleteAll(): bool
    {
        ...
        return delete_user_meta($this->userId, $this->metaKey);
    }
    ...
    /**
     * Load data from WordPress user meta.
     *
    ...
    /**
     * Save data to WordPress user meta.
     *
     * @param array<string, mixed> $data
     */
    protected function saveData(array $data): bool
    {
        ...
        return (bool) update_user_meta($this->userId, $this->metaKey, $data);
    }
}
