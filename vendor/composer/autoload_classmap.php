...
return array(
    ...
    'OptStack\\Core\\Condition\\Condition' => $baseDir . '/src/Core/Condition/Condition.php',
    'OptStack\\Core\\Condition\\ConditionEvaluator' => $baseDir . '/src/Core/Condition/ConditionEvaluator.php',
    'OptStack\\Core\\Container\\Tab' => $baseDir . '/src/Core/Container/Tab.php',
    'OptStack\\Core\\Contract\\RendererInterface' => $baseDir . '/src/Core/Contract/RendererInterface.php',
    'OptStack\\Core\\Contract\\SanitizableInterface' => $baseDir . '/src/Core/Contract/SanitizableInterface.php',
    'OptStack\\Core\\Contract\\StoreInterface' => $baseDir . '/src/Core/Contract/StoreInterface.php',
    'OptStack\\Core\\Contract\\ValidatableInterface' => $baseDir . '/src/Core/Contract/ValidatableInterface.php',
    'OptStack\\Core\\Field\\Field' => $baseDir . '/src/Core/Field/Field.php',
    'OptStack\\Core\\Field\\FieldCollection' => $baseDir . '/src/Core/Field/FieldCollection.php',
    'OptStack\\Core\\Field\\FieldGroup' => $baseDir . '/src/Core/Field/FieldGroup.php',
    'OptStack\\Core\\Index\\SearchableField' => $baseDir . '/src/Core/Index/SearchableField.php',
    'OptStack\\Core\\Index\\SearchableFieldResolver' => $baseDir . '/src/Core/Index/SearchableFieldResolver.php',
    'OptStack\\Core\\Path\\PathResolver' => $baseDir . '/src/Core/Path/PathResolver.php',
    'OptStack\\Core\\Stack\\Stack' => $baseDir . '/src/Core/Stack/Stack.php',
    'OptStack\\Core\\Stack\\StackBuilder' => $baseDir . '/src/Core/Stack/StackBuilder.php',
    'OptStack\\Core\\Stack\\StackRegistry' => $baseDir . '/src/Core/Stack/StackRegistry.php',
    'OptStack\\Core\\Support\\Arr' => $baseDir . '/src/Core/Support/Arr.php',
    'OptStack\\OptStack' => $baseDir . '/src/OptStack.php',
    'OptStack\\Schema\\SchemaExporter' => $baseDir . '/src/Schema/SchemaExporter.php',
    'OptStack\\Schema\\SchemaNormalizer' => $baseDir . '/src/Schema/SchemaNormalizer.php',
    'OptStack\\Support\\Context' => $baseDir . '/src/Support/Context.php',
    'OptStack\\Tests\\Unit\\ArrTest' => $baseDir . '/tests/php/Unit/ArrTest.php',
    'OptStack\\Tests\\Unit\\ConditionEvaluatorTest' => $baseDir . '/tests/php/Unit/ConditionEvaluatorTest.php',
    'OptStack\\Tests\\Unit\\ConditionTest' => $baseDir . '/tests/php/Unit/ConditionTest.php',
    'OptStack\\Tests\\Unit\\FieldGroupTest' => $baseDir . '/tests/php/Unit/FieldGroupTest.php',
    'OptStack\\Tests\\Unit\\FieldTest' => $baseDir . '/tests/php/Unit/FieldTest.php',
    'OptStack\\Tests\\Unit\\SearchableFieldTest' => $baseDir . '/tests/php/Unit/SearchableFieldTest.php',
    'OptStack\\WordPress\\Admin' => $baseDir . '/src/WordPress/Admin.php',
    'OptStack\\WordPress\\Bootstrap' => $baseDir . '/src/WordPress/Bootstrap.php',
    'OptStack\\WordPress\\Index\\IndexedMetaManager' => $baseDir . '/src/WordPress/Index/IndexedMetaManager.php',
    'OptStack\\WordPress\\Store\\OptionsStore' => $baseDir . '/src/WordPress/Store/OptionsStore.php',
    'OptStack\\WordPress\\Store\\PostStore' => $baseDir . '/src/WordPress/Store/PostStore.php',
    'OptStack\\WordPress\\Store\\TermStore' => $baseDir . '/src/WordPress/Store/TermStore.php',
    'OptStack\\WordPress\\Store\\UserStore' => $baseDir . '/src/WordPress/Store/UserStore.php',
